    ...
    <section id="story" className="relative py-14 md:py-20 overflow-hidden bg-theme-primary text-theme-primary border-t border-[#C6A15B]/15 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            <div className="relative h-[360px] sm:h-[460px] md:h-[540px] w-full rounded-2xl overflow-hidden glass-card border border-[#C6A15B]/30 shadow-2xl">
              <Image
            ...
            <div className="absolute -bottom-6 right-4 sm:right-6 glass-card border border-[#C6A15B]/40 p-4 sm:p-5 rounded-2xl max-w-[280px] sm:max-w-xs shadow-2xl space-y-1.5 overflow-hidden">
              <div className="flex items-center gap-2 text-gold">
                <Award className="w-4 h-4 shrink-0" />
                <span className="font-serif-luxury text-xs sm:text-sm font-semibold truncate">11 Years of Perfection</span>
              </div>
          ...
          >
            ...
            {/* Chef Quote */}
            <div className="p-4 sm:p-6 rounded-2xl glass-card border-l-4 border-[#C6A15B] relative space-y-2.5 overflow-hidden">
              ...
              <div className="flex items-center justify-between pt-1">
                <span className="text-xs font-serif-luxury text-gold tracking-wider font-semibold">
            ...
            <div className="space-y-3 pt-2">
              <h3 className="text-xs uppercase tracking-[0.2em] text-gold font-mono font-bold">
                Historical Milestones
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {STORY_TIMELINE.map((item) => (
                  <div key={item.year} className="p-3.5 rounded-xl border border-[#C6A15B]/20 glass-card hover:border-[#C6A15B]/50 transition-colors overflow-hidden">
                    <span className="font-mono text-base sm:text-lg text-gold font-bold">{item.year}</span>
                    <h4 className="font-serif-luxury text-xs sm:text-sm font-semibold mt-0.5 text-theme-primary truncate">{item.title}</h4>
