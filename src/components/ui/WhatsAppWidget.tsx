  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9000]">
      ...
      <button
        ...
        className="group relative flex items-center justify-center h-14 w-14 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-2xl hover:scale-110 transition-transform duration-300 interactive"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-18 right-0 w-80 sm:w-96 glass-card rounded-2xl p-6 border border-emerald-500/40 shadow-2xl z-50 text-theme-primary"
          >
            <div className="flex items-center justify-between border-b border-emerald-500/20 pb-4 mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-serif-luxury text-sm font-semibold">
                    WhatsApp Concierge
                  </h4>
              ...
              <button
                ...
                className="p-1 rounded-full text-gray-400 hover:text-emerald-500 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleSend} className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg px-2 py-1.5 text-xs focus:outline-none focus:border-emerald-500"
                  >
              ...
              <button
                type="submit"
                className="w-full mt-2 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold text-xs tracking-wider uppercase flex items-center justify-center gap-2 hover:opacity-90 transition-opacity interactive shadow-md"
              >
